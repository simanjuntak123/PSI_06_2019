...
/**
 * DetailPenggunaanDanaSearch represents the model behind the search form of `app\models\DetailPenggunaanDana`.
 */
class DetailPenggunaanDanaSearch extends DetailPenggunaanDana
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = DetailPenggunaanDana::find();
